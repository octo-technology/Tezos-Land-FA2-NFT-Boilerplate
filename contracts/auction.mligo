...
// WITHDRAW
// ligo compile-storage auction.mligo auction_main '{ ledger=Big_map.literal([(1n,("tz1b7tUupMgCNw2cCLpKTkSD1NZzB5TkP2sv":address))]); auctions=Big_map.literal([(1n,{startTime=("2020-09-30t12:16:00Z" : timestamp); endTime=("2020-10-01t12:16:00Z" : timestamp); owner=("tz1b7tUupMgCNw2cCLpKTkSD1NZzB5TkP2sv":address); bidIncrement=2n; highestBid=0mutez; highestBidOwner=("tz1b7tUupMgCNw2cCLpKTkSD1NZzB5TkP2sv":address); canceled=false; fundsByBidder=Map.literal([(("tz1L738ifd66ah69PrmKAZzckvvHnbcSeqjf":address), 3000mutez)]) })]) }'
// ligo compile-parameter auction.mligo auction_main ''
// ligo dry-run auction.mligo auction_main

// CANCEL
// ligo compile-storage auction.mligo auction_main ''
// ligo compile-parameter auction.mligo auction_main ''
// ligo dry-run auction.mligo auction_main
