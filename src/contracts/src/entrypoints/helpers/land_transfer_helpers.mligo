...
let transfer_bought_token (token_id, token_owner, buyer, operators, ledger, owners, emitter : token_id * address * address * operator_storage * ledger * owners * address option ) : ledger * owners =
    ...
    let ledger_with_transferred_token, owners_with_transferred_token: ledger * owners = transfer (token_transfer_transaction, transfer_validator, operators, ledger, owners, emitter) in
    ledger_with_transferred_token, owners_with_transferred_token
